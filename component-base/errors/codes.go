...
// base error codes must be 10_00_xx
const (
	// ErrSuccess - 200: OK.
...
// database codes codes must be 10_01_xx.
const (
	// ErrDatabase - 500: Database error.
	ErrDatabase int = iota + 100101
)

// auth codes codes must be 10_02_xx.
const (
	...
	// ErrInvalidAuthHeader - 401: Invalid authorize header.
...
// encoding/decoding codes codes must be 10_03_xx.
const (
